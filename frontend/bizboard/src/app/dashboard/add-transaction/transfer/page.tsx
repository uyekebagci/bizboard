...
/**
 * v1.7.0.x: /dashboard/add-transaction/transfer — dedicated Transfer formu.
 * TransferForm reuse — internal/external destek mevcut.
 */
    ...
    <div className="max-w-lg mx-auto space-y-6 pb-24">
      ...
      {showSuccess && (
        <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-sm flex items-center gap-2">
          ...
          Transfer oluşturuldu. Form temizlendi — başka bir transfer ekleyebilirsiniz.
        </div>
      )}
