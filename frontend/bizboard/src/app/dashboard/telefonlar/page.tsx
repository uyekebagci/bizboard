...
function PhoneDeviceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-surface-800 rounded-2xl shadow-xl border border-surface-600 w-full max-w-lg max-h-[90vh] overflow-y-auto">
...
function DeleteConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-surface-800 rounded-2xl shadow-xl border border-surface-600 w-full max-w-sm">
