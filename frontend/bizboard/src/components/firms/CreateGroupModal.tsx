    ...
    >
      ...
      >
        <div className="modal-header">
          <h3 className="text-base font-semibold text-[rgb(var(--v2-ink))]">Yeni Grup Oluştur</h3>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="mt-2 p-2.5 rounded-lg v2-sunken border border-[rgb(var(--v2-border))] flex items-center gap-2">
            <span className="text-[10px] uppercase text-[rgb(var(--v2-muted))]">Önizleme</span>
