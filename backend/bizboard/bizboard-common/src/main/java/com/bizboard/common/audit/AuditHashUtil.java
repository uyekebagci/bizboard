...
/**
 * Tamper-proof audit hash-chain yardımcıları.
 *
 ...
 *   <li>Zaman damgası nanosecond hassasiyetinde, {@link LocalDateTime#toString()} ile.</li>
 *   <li>Metadata anahtarları alfabetik sıraya konur ({@link TreeMap}) — Map iterasyon
 *       sırası JVM'e göre değişebileceği için.</li>
 *   <li>Ayraç/escape: değer içindeki {@code |} ve {@code \} karakterleri kaçırılır.</li>
 * </ul>
 *
 * <p>Bu sınıf saf fonksiyoneldir (durum tutmaz, yan etkisizdir) ve hiçbir alanı
 * mutasyona uğratmaz; çağıran taraf {@code prevHash}/{@code recordHash}'i kendi
 * yazar.</p>
 */
public final class AuditHashUtil {
    ...
    public static String computeRecordHash(AuditLog log, String prevHash) {
        String canonical = canonical(log, prevHash);
    ...
    static String canonicalMetadata(Map<String, Object> metadata) {
        ...
        // TreeMap → anahtarlar alfabetik; JVM Map iterasyon sırasından bağımsız.
    ...
    /** {@code \} ve {@code |} kaçırma — ayraç çakışmasını ve enjeksiyonu önler. */
    ...
    public static String sha256Hex(String input) {
        try {
            ...
            // SHA-256 her JVM'de zorunlu — buraya asla düşmez.
