...
/**
 * Admin audit log viewer + gelişmiş audit özellikleri (mod-audit v2).
 *
 ...
 * açıktır. {@code businessId} bir <i>filtre</i>dir, tenant izolasyonu değildir.</p>
 *
 * <ul>
 ...
 * </ul>
 *
 * <p><b>Login-safety:</b> bu controller'daki hiçbir endpoint audit YAZIM/login
 * yolunda değildir; tümü admin tarafından tetiklenen ek özelliklerdir.</p>
 */
@RestController
...
public class AdminAuditController {
     ...
     *
     * <p>v1.6.16.1: Spring native {@code Page<T>} yerine {@link PagedResponseDto} döner —
     * frontend {@code types/index.ts#PagedResponse} ile birebir snake_case eşleşme.</p>
     */
     ...
     * + kırılma noktası döner. Salt-okunur; DB'ye yazmaz.
     */
     ...
     * Scheduler zaten arka planda zincirler; bu endpoint manuel/anında tetikleme
     * sağlar. Audit'li (kim, kaç kayıt).
     */
     ...
     * (zincirlenmiş) kayıt {@code audit} event'i olarak yayınlanır. EventSource
     * header set edemediği için JWT, JwtAuthenticationFilter'ın query-param
     * fallback'i ({@code ?access_token=}) ile geçirilir — yine {@code /admin/**}
     * ROLE_ADMIN.
     */
     ...
     * Azami {@link AuditExportService#MAX_EXPORT_ROWS} satır.
     */
    ...
    public ResponseEntity<String> export(
        ...
        String contentType = json ? MediaType.APPLICATION_JSON_VALUE : "text/csv;charset=UTF-8";
