...
public class VersionController {
    ...
    private static final String VERSION_MARKER = "v1.1-hotfix-2026-06-03-tx-delete-transient-fix";
    private static final String BUILD_TIMESTAMP = "2026-06-03T03:00:00Z";
