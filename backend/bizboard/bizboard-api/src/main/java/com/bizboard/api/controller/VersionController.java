...
public class VersionController {
    ...
    private static final String VERSION_MARKER = "v1.1-hotfix-2026-06-02-tx-list-created-at-order";
    private static final String BUILD_TIMESTAMP = "2026-06-02T23:30:00Z";
