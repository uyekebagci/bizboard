...
public class VersionController {
    ...
    private static final String VERSION_MARKER = "v1.1-hotfix-2026-06-02-inclusion-aware-tx-list";
    private static final String BUILD_TIMESTAMP = "2026-06-02T22:00:00Z";
