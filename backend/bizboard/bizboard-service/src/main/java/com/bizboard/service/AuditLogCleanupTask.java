...
public class AuditLogCleanupTask {
    ...
    public void purgeOldAuditLogs() {
        // mod-audit v2: KVKK retention — önce anonimleştir (kayıt korunur, PII
        // kaldırılır), sonra retention dolanları sil. Anonimleştirme penceresi
        // (anonymize-after-days) genelde silme penceresinden (retention-days) KISA.
        runAnonymization();
        runPurge();
    }
